    ...
    <div class="px-6 py-6 max-w-lg mx-auto w-full flex flex-col font-sans">
      ...
      @if (!leadCaptured()) {
        <app-lead-capture
          ...
          description="Os melhores do nosso simulado podem ganhar prêmios e benefícios exclusivos! Para participar, precisamos de algumas informações para entrar em contato com os vencedores e montar a classificação de acordo com a sua região."
          icon="redeem"
