    ...
    <div class="fixed inset-0 z-[100] flex flex-col h-[100dvh] w-full bg-slate-100 dark:bg-slate-900 overflow-hidden">
      ...
      <div class="flex-grow w-full relative">
        <iframe
          ...
          sandbox="allow-scripts allow-same-origin allow-forms allow-popups allow-downloads allow-modals allow-top-navigation allow-top-navigation-by-user-activation allow-popups-to-escape-sandbox"
        ></iframe>
      </div>
    </div>
  `
